...
import RightsidebarCase from "./RightsidebarCase"
...
function CreateNewCase() {
  ...
  React.useEffect(() => {
	...
	const handleSubmit = () => {
        ...
        const dataobj = {"readOnly": true,"activeCaseExpertId":"",
                     "caseFlags": {
                ...
                <Row>
                    ...
                    <Col md="9">
                        <Card className="card-user">
                            <CardHeader >
                                <CardTitle tag="h5">Create case</CardTitle>

                            </CardHeader>
                            <hr></hr>
                            <CardBody>
                                <CardTitle tag="h4">Patient</CardTitle>
                                <Form   
                                     layout="vertical"
									form={form}
									size="large"
