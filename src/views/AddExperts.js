    ...
    formData.append("file", file, file.name);
       new ServiceStore().UploadImage(formData).then((res) => {
        ...
        const data = {firstname:e.target.firstname.value,lastname:e.target.lastname.value,
          ...
          profile:res.data.data.imagename,active:1,opencase:0,password:e.target.password.value,createdby:"",updatedby:""}
          console.log(data)
          const method = "/expert/addexpert"
      ...
      const data = {firstname:e.target.firstname.value,lastname:e.target.lastname.value,
        email:e.target.email.value,cemail:e.target.cemail.value,
        specialities:selected,phone:e.target.phone.value,resume:resume,
        profile:'',active:1,opencase:0,password:e.target.password.value,createdby:"",updatedby:""}
        console.log(data)
          const method = "/expert/addexpert"
          new ServiceStore().InsertData(method,data).then((res) => {
            if(res.response.status == 1){
                              ...
                              <div className="fields-wrapper">
                                  <div className="SplitColumnsContainer-sc-1h4sw88-0 bJeWYd">
                                      <div className="Field__Container-p9woft-1 eFssct  TextInput-yzpeng-7 gyICpj"><label
                                          ...
                                          <Input placeholder="John"  name = 'firstname' onChange={(e) => setvalidation('firstname',e.target.value)}
                                  ...
                                  <div className="SplitColumnsContainer-sc-1h4sw88-0 bJeWYd">
                                      <div className="Field__Container-p9woft-1 eFssct  TextInput-yzpeng-7 gyICpj"><label
                                              className="Field__Label-p9woft-2 cUWXcG">Email:<span
                                                  className="Field__Mandatory-p9woft-0 eOWGWb">*</span></label>
                                                  <Input
                                              placeholder="expert@email.com"    name = 'email'
                                      ...
                                      <div className="Field__Container-p9woft-1 eFssct  TextInput-yzpeng-7 gyICpj"><label
                                              className="Field__Label-p9woft-2 cUWXcG">Confirm email:<span
                                                  className="Field__Mandatory-p9woft-0 eOWGWb">*</span></label>
                                            <Input
                                              placeholder="expert@email.com"  name = 'cemail'
                                  ...
                                  <div className="SplitColumnsContainer-sc-1h4sw88-0 bJeWYd split-wrapper">
                                        <div className="Field__Container-p9woft-1 eFssct  TextInput-yzpeng-7 gyICpj"><label
                                            ...
                                            <div className="Field__Container-p9woft-1 eFssct  TextInput-yzpeng-7 gyICpj"><label
                                              ...
                                              <Input placeholder="+1 123-456-789" name = 'phone' 
                              ...
                              <div className="image-wrapper">
                                  <div className="sc-16rvg6y-1 esRQFJ">
                                    <Input  type="file" onChange={onFileSelect}
                                      ...
                                      <div className="sc-16rvg6y-2 sc-1vwtanf-0 bSMHSm"><span className="Icon-wsq54u-0 bWtdYP"></span></div>
                                      <button  className="Button-qe54pl-1 isEdxL styled-button" type="button">Add picture</button>
                                  </div>
                              </div>
                          </div>
                          <div>
